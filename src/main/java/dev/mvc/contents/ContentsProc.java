...
public class ContentsProc implements ContentsProcInter {
  ...
  public ArrayList<ContentsVO> list_cate(int cateno) {
    ArrayList<ContentsVO> list = this.contentsDAO.list_cate(cateno);
    return list;
  }

  @Override
  public int list_cate_count(int cateno) {
    int cnt = this.contentsDAO.list_cate_count(cateno);
    return cnt;
  }
  ...
  public int list_all_count() {
    int cnt = this.contentsDAO.list_all_count();
    return cnt;
  }
  ...
  public ArrayList<ContentsVO> list_all_search(HashMap<String, Object> hashmap) {
    ArrayList<ContentsVO> list = this.contentsDAO.list_all_search(hashmap);
    return list;
  }

  @Override
  public int list_all_search_count(HashMap<String, Object> hashmap) {
    int cnt = this.contentsDAO.list_all_search_count(hashmap);
    return cnt;
  }
  ...
  public ArrayList<ContentsVO> list_all_search_paging(HashMap<String, Object> hashmap) {
    ...
    ArrayList<ContentsVO> list = this.contentsDAO.list_all_search_paging(hashmap);
  ...
  public ArrayList<ContentsVO> list_cate_search(HashMap<String, Object> hashmap) {
    ArrayList<ContentsVO> list = this.contentsDAO.list_cate_search(hashmap);
    return list;
  }

  @Override
  public int list_cate_search_count(HashMap<String, Object> hashmap) {
    int cnt = this.contentsDAO.list_cate_search_count(hashmap);
    return cnt;
  }
  ...
  public int delete_by_cate(int cateno) {
    int cnt = this.contentsDAO.delete_by_cate(cateno);
    return cnt;
  }

  @Override
  public int count_by_member(int memberno) {
    int cnt = this.contentsDAO.count_by_member(memberno);
    return cnt;
  }

  @Override
  public int delete_by_member(int memberno) {
    int cnt = this.contentsDAO.delete_by_member(memberno);
    return cnt;
  }
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
  ...
  public int view(int contentsno) {
    int cnt = this.contentsDAO.view(contentsno);
    return cnt;
  }
  ...
  public int increase_commentcnt(int contentsno) {
    int cnt = this.contentsDAO.increase_commentcnt(contentsno);
    return cnt;
  }

  @Override
  public int decrease_commentcnt(int contentsno) {
    int cnt = this.contentsDAO.decrease_commentcnt(contentsno);
    return cnt;
  }
