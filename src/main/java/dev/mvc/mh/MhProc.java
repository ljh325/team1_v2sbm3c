...
//@Component("dev.mvc.mh.MhProc")
@Service("dev.mvc.mh.MhProc")
public class MhProc implements MhProcInter {
  @Autowired
  ...
  public int create(MhVO mhVO) {
    int cnt = this.mhDAO.create(mhVO);
    return cnt;
  }

  @Override
  public ArrayList<MhVO> list_all(int memberno) {
    ArrayList<MhVO> list = this.mhDAO.list_all(memberno);
    return list;
  }

  @Override
  public MhVO read(int mhno) {
    MhVO mhVO = this.mhDAO.read(mhno);
    return mhVO;
  }

  @Override
  public int update(MhVO mhVO) {
    int cnt = this.mhDAO.update(mhVO);
    return cnt;
  }
  ...
  public ArrayList<MhVO> list_search(String word) {
    ArrayList<MhVO> list = this.mhDAO.list_search(word);
    return list;
  }

  @Override
  public ArrayList<MhVO> list_search_paging(String word, int now_page, int record_per_page) {
    /*
    예) 페이지당 10개의 레코드 출력
    ...
    */
    ...
    ArrayList<MhVO> list=this.mhDAO.list_search_paging(map);
    return list;
  }

  @Override
  public int list_search_count(String word) {
    int cnt = this.mhDAO.list_search_count(word);
    return cnt;
  }
