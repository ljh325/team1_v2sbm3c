...
//@Component("dev.mvc.goals.GoalsProc")
@Service("dev.mvc.goals.GoalsProc")
public class GoalsProc implements GoalsProcInter {
  @Autowired
  private GoalsDAOInter goalsDAO;
  ...
  public int create(GoalsVO goalsVO) {
    int cnt = this.goalsDAO.create(goalsVO);
    return cnt;
  }

  @Override
  public ArrayList<GoalsVO> list_all(int memberno) {
    ArrayList<GoalsVO> list = this.goalsDAO.list_all(memberno);
    return list;
  }

  @Override
  public GoalsVO read(int goalsno) {
    GoalsVO goalsVO = this.goalsDAO.read(goalsno);
    return goalsVO;
  }

  @Override
  public int update(GoalsVO goalsVO) {
    int cnt = this.goalsDAO.update(goalsVO);
    return cnt;
  }

  @Override
  public int delete(int goalsno) {
    int cnt = this.goalsDAO.delete(goalsno);
    return cnt;
  }
  ...
  public ArrayList<GoalsVO> list_search(String word) {
    ArrayList<GoalsVO> list = this.goalsDAO.list_search(word);
    return list;
  }
  ...
  public ArrayList<GoalsVO> list_search_paging(String word, int now_page, int record_per_page) {
    ...
    */
    ...
    ArrayList<GoalsVO> list=this.goalsDAO.list_search_paging(map);
    return list;
  }

  @Override
  public int list_search_count(String word) {
    int cnt = this.goalsDAO.list_search_count(word);
    return cnt;
  }
