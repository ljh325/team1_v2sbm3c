...
if(action.equals("go")) {
    ...
    String user_id = base64Encode("juchan1212"); // SMS 아이디
    String secure = base64Encode("73786f7eccdffdba41d93253720f9cb2"); // 인증키
    ...
    String rphone = base64Encode(nullcheck(request.getParameter("tel"), ""));
